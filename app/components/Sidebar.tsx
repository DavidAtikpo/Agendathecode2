                ...
                <div className="space-y-1 border-t border-slate-700/60 px-2 py-2">
                  ...
                  {currentUser.role === 'admin' && (
                    <a
                      href="/admin"
                      onClick={() => afterNav()}
                      className="flex w-full items-center gap-2 rounded-lg px-2 py-2 text-left text-xs text-violet-300 hover:bg-slate-700/50 touch-manipulation"
                    >
                      <svg className="h-3.5 w-3.5 shrink-0 text-violet-400" fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-hidden>
